...
Other Julia packages, such as Oceananigans.jl [@ramadhan2020oceananigans] and TrixShallowWater.jl [@winters2025trixi], also provide tools for simulating shallow water and dispersive wave phenomena, but differ in their focus, supported models, and numerical methods.
